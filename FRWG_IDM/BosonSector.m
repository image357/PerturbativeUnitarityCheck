...
KineticLagrangian[HD1_,HD2_,w_,b_,vars_List:HiggsSector`higgsvars,complexvars_List:{}] := \
...
(* kinetic Lagrangian *)
K3Dm = KineticLagrangian[HiggsSector`HD1m, HiggsSector`HD2m, W, B, HiggsSector`higgsvars];
